...
("/net-eth" action "write" name "ens19" configuration "static" default "10.10.10.1" search "" dns "78.37.77.77" computer_name "k8s-worker2-2.dtd" ipv "4" ipv_enabled #t)
("/net-eth" action "add_iface_address" name "ens19" addip "10.10.10.204" addmask "24" ipv "4")
